<template>
  <div>
    ...
    <section class="experience">
      <article class="job">
        <a class="logo__link" href="https://www.aarixa.be" target="_blank">
          <img
            class="logo"
        ...
        <p>
          ...
          DevOps and system administration. Moving existing applications to new
          containers or virtual machines, but also monitoring and maintaining
          aariXa's infrastructure.
        </p>
      ...
      <article class="job">
        ...
        <a class="logo__link" href="https://www.bridgestone.eu" target="_blank">
          <img
            class="logo"
